  ...
  return (
    <>
      <div className="flex flex-col w-full min-h-screen h-full">
        <main className="flex flex-col justify-start flex-1 h-full lg:pb-[100px] lg:pt-[105px]">
          ...
          <div className="my-[9rem] lg:!m-auto">
      ...
      <footer className="fixed-bottom lg:relative h-[75px] z-50 bg-[#35408E] border-t-[8px] border-[#FFD41C]">
        {" "}
      </footer>
    </>
  );
